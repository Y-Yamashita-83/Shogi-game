...
class Board:
    ...
    def draw(self):
        ...
        if self.special_move_confirm:
            ...
            # 確認メッセージ
            if self.special_move_active.name == "メンコ" or self.special_move_active.name == "突風" or self.special_move_active.name == "変化の杖":
    ...
    def cancel_confirm(self):
        ...
        # メンコ、突風、変化の杖の場合は特殊技選択もキャンセルする
        if self.special_move_active and (self.special_move_active.name == "メンコ" or self.special_move_active.name == "突風" or self.special_move_active.name == "変化の杖"):
            self.special_move_active = None
